...
def main():
    ...
    parser.add_argument("--force_hf", action="store_true",
                        help="Force HuggingFace dataset loading instead of evalplus")
    ...
    if args.dataset == "custom":
        ...
        if args.dataset == "gsm8k":
            ...
            if EVALPLUS_AVAILABLE and not getattr(args, 'force_hf', False):
                ...
                logger.info(f"Using HuggingFace MBPP dataset (split={args.dataset_split})")
