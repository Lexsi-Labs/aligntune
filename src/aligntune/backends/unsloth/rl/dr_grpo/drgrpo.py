...
class UnslothDRGRPOTrainer(TrainerBase):
    ...
    def setup_rewards(self) -> None:
        ...
        for reward_config in rewards_config:
            ...
            try:
                # ⭐ CRITICAL: Handle custom rewards FIRST, before any registry lookup
                if reward_type == 'custom' and 'reward_function' in params:
                    ...
                    continue  # ⭐ Skip registry lookup for custom rewards
    ...
    def setup_trainer(self) -> None:
        ...
        try:
            ...
            run_name = self._get_config_value(
                self.config.logging, 'run_name', default='unsloth_drgrpo')
            ...
            loss_type = self._get_config_value(
                self.config.train, 'loss_type', default='dr_grpo')
    ...
    def save_model(self, path: Optional[str] = None) -> str:
        ...
        try:
            ...
            config_path = Path(save_path) / "drgrpo_training_config"
