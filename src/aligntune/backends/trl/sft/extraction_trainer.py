"""
Schema-Guided JSON Extraction Trainer for AlignTune v3.10

Extends SFTTrainer to support structured JSON output with schema validation.
Adds auxiliary loss term that penalizes structurally invalid JSON outputs.
...
- Compatible with any causal LM architecture
"""
...
class ExtractionTrainerConfig:
    """Configuration for Schema-Guided JSON Extraction Trainer."""
...
class ExtractionControlledSFTTrainer(SFTTrainer):
    """
    SFT Trainer with schema-guided JSON extraction support.
    ...
    def __init__(self, config: ExtractionTrainerConfig, *args, **kwargs):
        """
        Initialize Extraction-controlled SFT Trainer.
        ...
        logger.info("ExtractionControlledSFTTrainer initialized")
...
class ExtractionTrainer:
    """
    Wrapper class for easy schema-guided JSON extraction training.
    ...
    def __init__(self, config: ExtractionTrainerConfig):
        ...
        logger.info("ExtractionTrainer initialized")
    ...
    def setup_trainer(self, train_dataset, eval_dataset=None):
        """
        Setup ExtractionControlledSFTTrainer.
        ...
        # Create trainer
        self.trainer = ExtractionControlledSFTTrainer(
            config=self.config,
            model=self.model,
        ...
        logger.info("ExtractionControlledSFTTrainer setup complete")
    ...
    def train(self):
        ...
        logger.info("Starting schema-guided JSON extraction training...")
        self.trainer.train()
