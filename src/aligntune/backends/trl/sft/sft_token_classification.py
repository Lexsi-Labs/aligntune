"""Token Classification Trainer (NER, POS tagging, chunking, etc.)."""
...
class TokenClassificationTrainer(SFTTrainerBase):
    """Trainer for token classification (NER, POS, etc.). Uses HF Trainer with AutoModelForTokenClassification."""
    ...
    def __init__(self, config):
        ...
        logger.info("TokenClassificationTrainer initialized")
    ...
    def run_experiment(self):
        logger.info("Starting token classification experiment")
        try:
