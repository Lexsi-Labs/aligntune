...
| --- | --- | --- | --- | --- | --- |
| SFT | TRL | SFT | **Qwen/Qwen3-4B-Instruct-2507** | sohamb37lexsi/bitext-wealth-management-llm-chatbot-splits | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1okAnfMlkch-G5Dy2dmj_dfR07rtxmYoq?usp=sharing) |
| SFT | TRL | SFT | **Qwen3-4B-Instruct** | sohamb37lexsi/bitext-retail-banking-llm-chatbot-splits | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1JnFvEWZ6PDqrDAyWznCdOA9oNn8aqN2v?usp=sharing) |
| SFT | Unsloth | SFT | **Qwen/Qwen2.5-0.5B-Instruct** | bebechien/MobileGameNPC | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/15R3JOrzAUuMagCamDHsqe0wNyb44rw2j?usp=sharing) |
| SFT | TRL | SFT | **google/txgemma-2b-predict** | trialbench_adverse-event-rate-prediction | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1oTI_0fc3x4u3fs5Q2ccFBc5g45q3ScWY?usp=sharing) |
| SFT | Unsloth | SFT | **Qwen/Qwen2.5-0.5B-Instruct** | bebechien/MobileGameNP | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/11DrRbG30MUCegZTDXwR9nxEdvKaLfWCb?usp=sharing) |
| RL | Unsloth | **DPO** | microsoft/phi-2 | argilla/distilabel-intel-orca-dpo-pairs | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1aKdQzT7KGs0PEr7pO9rOXFkwQK6LzyRZ#scrollTo=dOnIJIAMxP9J) |
| RL | TRL | **DPO** | google/gemma-2-2b-it | Anthropic/hh-rlhf | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1WQhek61Z0v1zHFWT4mQwVX7n10ln-j3d?usp=sharing) |
| RL | TRL | **DPO** | sohamb37lexsi/wealth_management_Qwen3-4B-Instruct-2507 | sohamb37lexsi/bitext_wealth_management_preference_data | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1LR3KWcjQAFjSHf0MR9271ShchjPUVSpS?usp=sharing) |
| RL | Unsloth | **PPO** | Qwen/Qwen2.5-0.5B-Instruct | HuggingFaceH4/ultrachat_200k | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1G4fdtO4DhBNwjOYhuaGmvIrBU_lc159H?usp=sharing) |
| RL | TRL | **PPO** | EleutherAI/pythia-1.4b | CarperAI/openai_summarize_tldr | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1Wwk8lxtzP-xzOwIIgxYrUjQ1i4J_N6ZO?usp=sharing) |
| RL | TRL | **GRPO** (Coding) | Qwen/Qwen3-4B | google-research-datasets/mbpp | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/13HYZ-EkLC3-6wxJG_1NyWXPEuN9bIeM4?usp=sharing) |
| RL | Unsloth | **GRPO** (Math) | meta-llama/Llama-3.2-3B-Instruct | openai/gsm8k | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1mpG2gbHjk5CaSKkuoQFXxDY0fzFVIilb?usp=sharing) |
| RL | TRL | **GRPO** | meta-llama/Llama-3.2-3B-Instruct | openai/gsm8k | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/14b2dt0_iSVL8Z_8mlOx--f-d_rDCqVOP?usp=sharing) |
| RL | Unsloth | **DRGRPO** | Qwen/Qwen2.5-3B-Instruct | yahma/alpaca-cleaned | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1fAFF9LAyQw0sJfxQTE_HLaF0Xl56hfsG?usp=sharing) |
| RL | TRL | **DRGRPO** | Qwen/Qwen2-0.5B-Instruct | AI-MO/NuminaMath-TIR | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1KfrMzuGRPrZwyRuNTGep1ZL6C6h2aVjk?usp=sharing) |
| RL | Unsloth | **GSPO** | Qwen/Qwen3-1.7B | CyberNative/Code_Vulnerability_Security_DPO | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1k9UjIqdNClnGADeJzfVUeE6UVgjzc5wV?usp=sharing) |
| RL | TRL | **GSPO** | meta-llama/Llama-3.2-3B-Instruct | HuggingFaceH4/ultrachat_200k | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1k9UjIqdNClnGADeJzfVUeE6UVgjzc5wV?usp=sharing) |
| RL | Unsloth | **DAPO** | microsoft/Phi-3.5-mini-instruct | HuggingFaceH4/ultrachat_200k | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1gAa6EPc5345XRfog1nzQIFTmp_OJqNvk?usp=sharing) |
| RL | TRL | **DAPO** | meta-llama/Llama-3.2-3B-Instruct | google-research-datasets/mbpp | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1aF3LxEMmLl0fCyA5yVBAkU_Rgsy3dsh5?usp=sharing) |
| RL | TRL | **SPIN** | umarigan/llama3.2-1B-fin | gbharti/finance-alpaca | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1F0bNI87dxeP9hkhtCpsHTKLG1McnKcEz?usp=sharing) |
| RL | TRL | **ORPO** | meta-llama/Llama-3.2-1B-Instruct (then SFT output) | bhavyagoyal-lexsi/orpo-ds | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1hYZ_Kxn6eMIAY8EiukJi3VuWIOMpv_yT?usp=sharing) |
| Distillation | TRL | Offline knowledge distillation (teacher: OpenDataArena/ODA-Fin-SFT-8B) | **Qwen/Qwen3-1.7B** | bhavyagoyal-lexsi/FINANCE-offline-online-distillation-data | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1PB3jBKoc1bKi5_8qB3KgKCedMqA1P-rT?usp=sharing) |
| Distillation | TRL | Online knowledge distillation (teacher: nvidia/Riva-Translate-4B-Instruct-v2) | **tencent/Hy-MT2-1.8B** | Helsinki-NLP/opus-100 (en-hi) | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1ge7mE9o1MwYM-2I8oflSlZJcDfJS38bq?usp=sharing) |
| Distillation | TRL | Self-distillation fine-tuning (SDFT, self-teacher) | **LiquidAI/LFM2.5-2.6B** | — | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1_P98jmisLxJSsnEpNcOuoV4ERjt9Sqz2?usp=sharing) |
| Tokenization | — | Vocabulary extension (continued BPE, Arabic) | **gpt2** | M-A-D/Mixed-Arabic-Datasets-Repo | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1RxBVqXgfcp8UzdNE27XZQpknwOmG2qGS?usp=sharing) |
| Embedding | TRL | Tokenizer + embedding adaptation, then LoRA SFT (Marathi) | **LiquidAI/LFM2.5-1.2B-Instruct** | ai4bharat/sangraha + saillab/alpaca-marathi-cleaned | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1Fccrynx2lifVDjTycifYMQ4PjEtqvXQA?usp=sharing) |
| Long context | TRL | RoPE scaling (context-window extension) | **HuggingFaceTB/SmolLM-1.7B-Instruct** | bavest/fin-llama-dataset | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1d-3HCq4H9mY6jDg5ezr4k34XypNdR66t?usp=sharing) |
| Long context | TRL | Sliding-window attention (SWA) | **Qwen/Qwen2.5-3B** | Sakshi1307/FindSUM | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1TgEb40JU43oAiZKdH3wgiJVUpnbk74IC?usp=sharing) |
| Long context | TRL | Shifted sparse attention (S2-Attn) | **meta-llama/Llama-3.2-3B-Instruct** | mrSoul7766/ECTSum + ChanceFocus/flare-edtsum | [![Open In Colab](https://img.shields.io/badge/Open%20in%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/1ZtshdGOMC4ON1I3d-uy-_PI0_ENp6k_h?usp=sharing) |
...
- **Third-party components**: Vendored dependencies under `third_party/` keep their own licenses — some are copyleft (LGPL-3.0, AGPL-3.0) and those terms continue to apply to those components. See [THIRD_PARTY_LICENSES.md](https://github.com/Lexsi-Labs/aligntune/blob/main/THIRD_PARTY_LICENSES.md).
