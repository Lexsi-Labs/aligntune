# -*- coding: utf-8 -*-
"""unsloth_grpo_1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/11tj2odJa7v55VvQkpOlm7_WBclqFdaVi
...
# GRPO Training with GSM8K (TRL Backend) - Direct API
This notebook is divided into 3 cells:
...
# CELL 1: PRE-TRAINING EVALUATION
#!/usr/bin/env python3
"""
GRPO Training with GSM8K (TRL Backend) - Direct API approach (no YAML config)
"""
...
def run_evaluation(model_path, output_dir, is_pre_training=False, use_lora=False, base_model=None):
    ...
    return {
        'math': result.get('math_accuracy', 0.0),
...
output_dir = "output_direct_unsloth"
model_name = "meta-llama/Llama-3.2-3B-Instruct"
results = {'model': model_name, 'dataset': 'openai/gsm8k', 'output_dir': output_dir}

"""#### If Recompiled limit error comes increase the cache limit Session ```torch._dynamo.config.cache_size_limit```  and restart"""
...
trainer = create_rl_trainer(
    ...
    batch_size=32,                    # Reduced for faster generation
...
try:
    ...
    print(f"✅ Pre-training accuracy: {pre_eval_results['math']*100:.2f}%")
...
try:
    ...
    print(f"✅ Post-training accuracy: {post_eval_results['math']*100:.2f}%")
except Exception as e:
...
if pre_eval_results and post_eval_results:
    pre_accuracy = pre_eval_results['math'] * 100
    post_accuracy = post_eval_results['math'] * 100
    ...
    print(f"📊 Pre-training:   {pre_accuracy:.2f}%")
    print(f"📊 Post-training:  {post_accuracy:.2f}%")
